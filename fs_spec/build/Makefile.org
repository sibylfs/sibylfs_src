...
#+AUTHOR: Tom Ridge
#+OPTIONS: title:true toc:nil

#+PROPERTY: header-args :tangle Makefile.tmp :exports code 
...
cmx: generated_ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c abstract_string.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c lem_support.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c fs_interface.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c list_array.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c fs_prelude.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c fs_spec.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c dir_heap.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c fs_dict_wrappers.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -package sha -c fs_dump.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c fs_printer.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c fs_interface.mli
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c abstract_string.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c list_array.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -syntax camlp4o -c lem_support.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c fs_prelude.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c fs_dict_wrappers.ml
	$(CAMLOPT) $(CAMLCINCLUDES) -package sexplib,sexplib.syntax -c fs_interface.ml
  touch cmx
